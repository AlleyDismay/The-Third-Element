...
class Game:
    ...
    def loadStats(self):
        ...
        try:
            ...
            self.treasure.collectedItems = set(data[3].split())
        ...
        #self.startOver = True
        self.story.mainWorldMsgFinished = True
